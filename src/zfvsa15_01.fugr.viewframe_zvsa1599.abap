*---------------------------------------------------------------------*
*    program for:   VIEWFRAME_ZVSA1599
*   generation date: 2022.08.01 at 10:14:19
*   view maintenance generator version: #001407#
*---------------------------------------------------------------------*
FUNCTION VIEWFRAME_ZVSA1599            .
...
*----------------------------------------------------------------------*
CALL FUNCTION 'VIEWPROC_ZVSA1599'
         EXPORTING
              FCODE          = READ
...
EXTRACT = ZVSA1599_EXTRACT
TOTAL = ZVSA1599_TOTAL
              X_HEADER       = X_HEADER
              X_NAMTAB       = X_NAMTAB
...
CALL FUNCTION 'VIEWPROC_ZVSA1599'
             ...
             IMPORTING
                  UCOMM           = FUNCTION
UPDATE_REQUIRED = STATUS_ZVSA1599-UPD_FLAG
             TABLES
                  EXCL_CUA_FUNCT  = EXCL_CUA_FUNCT
EXTRACT = ZVSA1599_EXTRACT
TOTAL = ZVSA1599_TOTAL
...
*----------------------------------------------------------------------*
      ...
      IF ( FUNCTION EQ SWITCH_TO_SHOW_MODE OR
           ...
           FUNCTION EQ END ) AND
STATUS_ZVSA1599-UPD_FLAG NE SPACE.
        PERFORM BEENDEN.
        CASE SY-SUBRC.
          WHEN 0.
CALL FUNCTION 'VIEWPROC_ZVSA1599'
...
TOTAL = ZVSA1599_TOTAL
            ...
            CASE SY-SUBRC.
              WHEN 0.
IF STATUS_ZVSA1599-UPD_FLAG EQ SPACE. EXIT. ENDIF.
...
IF STATUS_ZVSA1599-UPD_FLAG NE SPACE.
